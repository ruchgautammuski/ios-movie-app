...
class HomeViewController: UIViewController {
    ...
    let  sectionTitles: [String] = ["Thriller", "Romantic", "Upcoming Movies"  ,"Horror", ]
...
//guard let header = view as? UITableViewHeaderFooterView else { return }
//header.textLabel?.font = .systemFont(ofSize: 18, weight: .semibold)
//header.textLabel?.frame = CGRect(x: header.bounds.origin.x + 20, y: header.bounds.origin.y, width: //
//100, height: header.bounds.height)
//}
